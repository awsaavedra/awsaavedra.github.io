...
## 1. Building ChatGPT2 from Scratch and Documenting it

<details>
<summary><strong>An extensive exercise in thinking, reading, and coding to build an LLM from the ground up.</strong></summary>

This was an extensive exercise is thinking and reading with some coding.

The major contributions I made were the following:

1. Documenting all the steps and research used to understand how to build an LLM

2. Explaining all the computational complexity and the "why" for anyone whose willing and interested as long as they have some basic numeracy.
...
## 2. Graduate Research on AI Assistants for Productivity and Creativity Enhancement

<details>
<summary><strong>Mixed-methods research on how AI assistants affect expert productivity and creativity.</strong></summary>
...
## 3. Guru Indexer, Guru investor returns for index fund costs

<details>
<summary><strong>A concentrated long-term outperformance strategy aggregating stock data from top value investors.</strong></summary>
...
## 4. GarageHub, the Airbnb of garage space

<details>
<summary><strong>A marketplace platform targeting the $20M+ San Francisco garage space market.</strong></summary>
...
## 5. Valley of the Khan’s: The Search for Genghis Khan’s Tomb

<details>
<summary><strong>Applied machine learning to satellite imagery to identify paths in Mongolia for National Geographic.</strong></summary>
